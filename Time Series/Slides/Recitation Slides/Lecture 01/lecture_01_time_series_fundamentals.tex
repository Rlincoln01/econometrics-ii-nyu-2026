...
\subtitle{Recitation Session 1: Introduction to Stochastic Processes}
...
\begin{frame}{Today's Roadmap}
    \begin{enumerate}
        \item \hyperlink{part-intro}{\textbf{Introduction: Why Time Series?}}
        \begin{itemize}
        ...
        \end{itemize}
        \vspace{0.5em}
        \item \hyperlink{part-stochastic}{\textbf{Introduction to Stochastic Processes}}
        \begin{itemize}
            \item \hyperlink{part-stochastic}{Formal definitions: Filtrations, measurability}
            \item \hyperlink{part-models}{Models: DGP, correct specification}
            \item \hyperlink{part-models}{Key restrictions: Stationarity}
            \item \hyperlink{part-ops}{Linear operators (lag \& difference)}
        \end{itemize}
        \vspace{0.5em}
        \item \hyperlink{part-examples}{\textbf{Examples from Macroeconomics}}
        \begin{itemize}
...
% PART I: INTRODUCTION
% ============================================================================
\begin{frame}[plain,label=part-intro]
    \begin{center}
...
% ============================================================================
\begin{frame}[plain,label=part-stochastic]
    \begin{center}
...
\begin{frame}{Measurable Functions}
    \begin{definition}[Measurable Function]
        A function $f: \Omega \to \widetilde{\Omega}$ between measure spaces $(\Omega, \F)$ and $(\widetilde{\Omega}, \widetilde{\F})$ is $\F/\widetilde{\F}$-\textbf{measurable} if its inverse preserves measurability:
        \[
...
% ============================================================================
\begin{frame}[plain,label=part-models]
    \begin{center}
...
% ============================================================================
\begin{frame}[plain,label=part-ops]
    \begin{center}
...
% PART III: EXAMPLES
% ============================================================================
\begin{frame}[plain,label=part-examples]
    \begin{center}

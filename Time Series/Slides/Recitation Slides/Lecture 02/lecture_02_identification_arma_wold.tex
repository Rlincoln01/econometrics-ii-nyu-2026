...
% TIM'S EXERCISES
% ----------------------------------------------------------------------------
\begin{frame}{Tim's Practice Problems: Exercise 2 (MA($q$) properties)}
    \footnotesize
    \begin{block}{Problem}
...
\begin{frame}{Exercise 2 (MA($q$)): Solution}
    \footnotesize
...
% ----------------------------------------------------------------------------
\begin{frame}{Tim's Practice Problems: Exercise 2 (MA(2) invertibility)}
    \footnotesize
    \begin{block}{Problem}
...
\begin{frame}{Exercise 2 (MA(2)): Solution}
    \footnotesize
...
% ----------------------------------------------------------------------------
\begin{frame}{Tim's Practice Problems: Exercise 3 (nonstationary bivariate)}
    \footnotesize
    \begin{block}{Problem}
